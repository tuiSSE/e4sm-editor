/************************************************************
	...
	Transition_Act2__execution.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Act2__execution::Transition_Act2__execution(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "Act2_main"))),
	pool_Place ( *(net->getPlace( &places, "P_thread_pool"))),
	nona1_Place ( *(net->getPlace( &places, "Act2_executed")))
{
}

Transition_Act2__execution::~Transition_Act2__execution()
{
}

bool Transition_Act2__execution::globalGuard()
{
	return true;
}
void Transition_Act2__execution::initGlobalGuards()
{
}

void Transition_Act2__execution::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Act2__execution::generateBindingList()
{
	TokenList* tok;
...
void Transition_Act2__execution::log(TokenList &binding)
{
}

double Transition_Act2__execution::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Act2__execution::getFiringDelay(TokenList &binding) const
{
...
bool Transition_Act2__execution::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Act2__execution::Timeguard(const DateTime& now)
{
	return 0.0;
}
