 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.ArcType#getInscription <em>Inscription</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.ArcType#getHandle <em>Handle</em>}</li>
 * </ul>
 *
 * @see de.ilmenau.tu.timenet.schema.scpn.scpnPackage#getArcType()
...
public interface ArcType extends ConnectorType {
	 ...
	 * @see de.ilmenau.tu.timenet.schema.scpn.scpnPackage#getArcType_Inscription()
	...
	/**
	 * Sets the value of the '{@link de.ilmenau.tu.timenet.schema.scpn.ArcType#getInscription <em>Inscription</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.ilmenau.tu.timenet.schema.scpn.HandleType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Handle</em>' containment reference list.
	 * @see de.ilmenau.tu.timenet.schema.scpn.scpnPackage#getArcType_Handle()
