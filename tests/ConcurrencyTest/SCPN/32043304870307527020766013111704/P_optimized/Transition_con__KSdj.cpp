/************************************************************
	...
	Transition_con__KSdj.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_con__KSdj::Transition_con__KSdj(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "C1_out2"))),
	nona1_Place ( *(net->getPlace( &places, "A_in_2_1")))
{
}

Transition_con__KSdj::~Transition_con__KSdj()
{
}

bool Transition_con__KSdj::globalGuard()
{
	return true;
}
void Transition_con__KSdj::initGlobalGuards()
{
}

void Transition_con__KSdj::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_con__KSdj::generateBindingList()
{
	TokenList* tok;
...
void Transition_con__KSdj::log(TokenList &binding)
{
}

double Transition_con__KSdj::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_con__KSdj::getFiringDelay(TokenList &binding) const
{
...
bool Transition_con__KSdj::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_con__KSdj::Timeguard(const DateTime& now)
{
	return 0.0;
}
