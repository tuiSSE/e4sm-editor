/************************************************************
	...
	Transition_A3__ready.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_A3__ready::Transition_A3__ready(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "A3_main")))
{
}

Transition_A3__ready::~Transition_A3__ready()
{
}

bool Transition_A3__ready::globalGuard()
{
	return true;
}
void Transition_A3__ready::initGlobalGuards()
{
}

void Transition_A3__ready::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_A3__ready::generateBindingList()
{
	TokenList* tok;
...
void Transition_A3__ready::log(TokenList &binding)
{
}

double Transition_A3__ready::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_A3__ready::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_A3__ready::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_A3__ready::Timeguard(const DateTime& now)
{
	return 0.0;
}
