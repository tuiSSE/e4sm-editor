 ...
 * </p>
 * <ul>
 *   <li>{@link e4sm.de.metamodel.e4sm.core.impl.VariantImpl#getDocumentation <em>Documentation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariantImpl extends NamedElementImpl implements Variant {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.VARIANT;
	}
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIANT__DOCUMENTATION, oldDocumentation,
					documentation));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DocumentableElement.class) {
			...
			case CorePackage.DOCUMENTABLE_ELEMENT__DOCUMENTATION:
				return CorePackage.VARIANT__DOCUMENTATION;
			default:
				return -1;
			}
		}
