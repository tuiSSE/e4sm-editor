...
import abcd.xy.metamodel.abcd.analysis.impl.AnalysisPackageImpl;
import abcd.xy.metamodel.abcd.analysis.results.ResultsPackage;
import abcd.xy.metamodel.abcd.analysis.results.impl.ResultsPackageImpl;
...
import abcd.xy.metamodel.abcd.execution.impl.ExecutionPackageImpl;
import abcd.xy.metamodel.abcd.guava.GuavaPackage;
import abcd.xy.metamodel.abcd.guava.impl.GuavaPackageImpl;
import abcd.xy.metamodel.abcd.core.impl.CorePackageImpl;
 ...
 * @generated
 */
public class abcdPackageImpl extends EPackageImpl implements abcdPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see abcd.xy.metamodel.abcd.abcdPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private abcdPackageImpl() {
		super(eNS_URI, abcdFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link abcdPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static abcdPackage init() {
		if (isInited)
			return (abcdPackage) EPackage.Registry.INSTANCE.getEPackage(abcdPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredabcdPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		abcdPackageImpl theabcdPackage = registeredabcdPackage instanceof abcdPackageImpl
				? (abcdPackageImpl) registeredabcdPackage
				: new abcdPackageImpl();
		...
		theabcdPackage.createPackageContents();
		...
		theabcdPackage.initializePackageContents();
		...
		EValidator.Registry.INSTANCE.put(theabcdPackage, new EValidator.Descriptor() {
			@Override
			public EValidator getEValidator() {
				return abcdValidator.INSTANCE;
			}
		});

		// Mark meta-data to indicate it can't be changed
		theabcdPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(abcdPackage.eNS_URI, theabcdPackage);
		return theabcdPackage;
	}
	 ...
	 */
	@Override
	public abcdFactory getabcdFactory() {
		return (abcdFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(packageEClass, abcd.xy.metamodel.abcd.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Components(), this.getComponent(), null, "components", null, 0, -1,
				abcd.xy.metamodel.abcd.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackage_SoftwareComponents(), this.getSoftwareComponent(), null, "softwareComponents", null,
				0, -1, abcd.xy.metamodel.abcd.Package.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPackage_SpecifiesComponent(), this.getComponent(), this.getComponent_SpecifiedInPackage(),
				"specifiesComponent", null, 0, 1, abcd.xy.metamodel.abcd.Package.class, !IS_TRANSIENT, !IS_VOLATILE,
