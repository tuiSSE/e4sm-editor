 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.TextTypeImpl#getGraphics <em>Graphics</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.TextTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.TextTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextTypeImpl extends MinimalEObjectImpl.Container implements TextType {
	...
	protected EClass eStaticClass() {
		return EDSPNPackage.Literals.TEXT_TYPE;
	}
	...
	public NotificationChain basicSetGraphics(GraphicsType newGraphics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EDSPNPackage.TEXT_TYPE__GRAPHICS, oldGraphics, newGraphics);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newGraphics != graphics) {
			...
			if (graphics != null)
				msgs = ((InternalEObject) graphics).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EDSPNPackage.TEXT_TYPE__GRAPHICS, null, msgs);
			if (newGraphics != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.TEXT_TYPE__GRAPHICS, newGraphics,
					newGraphics));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.TEXT_TYPE__ID, oldId, id));
	}
	...
	public void setType(Type newType) {
		...
		typeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.TEXT_TYPE__TYPE, oldType, type,
					!oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EDSPNPackage.TEXT_TYPE__TYPE, oldType,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case EDSPNPackage.TEXT_TYPE__GRAPHICS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EDSPNPackage.TEXT_TYPE__GRAPHICS:
			return getGraphics();
		case EDSPNPackage.TEXT_TYPE__ID:
			return getId();
		case EDSPNPackage.TEXT_TYPE__TYPE:
			return getType();
		}
