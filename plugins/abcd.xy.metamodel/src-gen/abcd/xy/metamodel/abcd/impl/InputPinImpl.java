 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.InputPinImpl#getQueueType <em>Queue Type</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.InputPinImpl#getCollect <em>Collect</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.InputPinImpl#isOptional <em>Optional</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputPinImpl extends PinImpl implements InputPin {
	...
	protected EClass eStaticClass() {
		return abcdPackage.Literals.INPUT_PIN;
	}
	...
	public void setQueueType(QueueType newQueueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.INPUT_PIN__QUEUE_TYPE, oldQueueType,
					queueType));
	}
	...
	public void setCollect(int newCollect) {
		...
		collect = newCollect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.INPUT_PIN__COLLECT, oldCollect, collect));
	}
	...
	public void setOptional(boolean newOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.INPUT_PIN__OPTIONAL, oldOptional,
					optional));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case abcdPackage.INPUT_PIN__QUEUE_TYPE:
			return getQueueType();
		case abcdPackage.INPUT_PIN__COLLECT:
			return getCollect();
		case abcdPackage.INPUT_PIN__OPTIONAL:
			return isOptional();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case abcdPackage.INPUT_PIN___COMPUTE_NAME:
			return computeName();
		}
