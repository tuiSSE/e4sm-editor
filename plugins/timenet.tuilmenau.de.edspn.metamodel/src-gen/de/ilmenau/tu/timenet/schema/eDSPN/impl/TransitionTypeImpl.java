 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.TransitionTypeImpl#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionTypeImpl extends NodeTypeImpl implements TransitionType {
	...
	protected EClass eStaticClass() {
		return EDSPNPackage.Literals.TRANSITION_TYPE;
	}
	...
	public NotificationChain basicSetLabel(LabelType newLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EDSPNPackage.TRANSITION_TYPE__LABEL, oldLabel, newLabel);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLabel != label) {
			...
			if (label != null)
				msgs = ((InternalEObject) label).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EDSPNPackage.TRANSITION_TYPE__LABEL, null, msgs);
			if (newLabel != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.TRANSITION_TYPE__LABEL, newLabel,
					newLabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case EDSPNPackage.TRANSITION_TYPE__LABEL:
