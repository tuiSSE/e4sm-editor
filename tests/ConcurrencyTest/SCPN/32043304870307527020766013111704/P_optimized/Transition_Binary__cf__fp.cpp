/************************************************************
	...
	Transition_Binary__cf__fp.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Binary__cf__fp::Transition_Binary__cf__fp(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "Binary_fp")))
{
}

Transition_Binary__cf__fp::~Transition_Binary__cf__fp()
{
}

bool Transition_Binary__cf__fp::globalGuard()
{
	return true;
}
void Transition_Binary__cf__fp::initGlobalGuards()
{
}

void Transition_Binary__cf__fp::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Binary__cf__fp::generateBindingList()
{
	TokenList* tok;
...
void Transition_Binary__cf__fp::log(TokenList &binding)
{
}

double Transition_Binary__cf__fp::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Binary__cf__fp::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Binary__cf__fp::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Binary__cf__fp::Timeguard(const DateTime& now)
{
	return 0.0;
}
