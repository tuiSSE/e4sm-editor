 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.ConnectorTypeImpl#getFromNode <em>From Node</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.ConnectorTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.ConnectorTypeImpl#getToNode <em>To Node</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.ConnectorTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectorTypeImpl extends MinimalEObjectImpl.Container implements ConnectorType {
	...
	protected EClass eStaticClass() {
		return EDSPNPackage.Literals.CONNECTOR_TYPE;
	}
	...
	public void setFromNode(String newFromNode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.CONNECTOR_TYPE__FROM_NODE, oldFromNode,
					fromNode));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.CONNECTOR_TYPE__ID, oldId, id));
	}
	...
	public void setToNode(String newToNode) {
		...
		toNode = newToNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.CONNECTOR_TYPE__TO_NODE, oldToNode,
					toNode));
	}
	...
	public void setType(Type newType) {
		...
		typeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.CONNECTOR_TYPE__TYPE, oldType, type,
					!oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EDSPNPackage.CONNECTOR_TYPE__TYPE, oldType,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EDSPNPackage.CONNECTOR_TYPE__FROM_NODE:
			return getFromNode();
		case EDSPNPackage.CONNECTOR_TYPE__ID:
			return getId();
		case EDSPNPackage.CONNECTOR_TYPE__TO_NODE:
			return getToNode();
		case EDSPNPackage.CONNECTOR_TYPE__TYPE:
			return getType();
		}
