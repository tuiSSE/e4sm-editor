/************************************************************
	...
	Transition_con__bxwf.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_con__bxwf::Transition_con__bxwf(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "P_In_out1"))),
	nona1_Place ( *(net->getPlace( &places, "P_Out_in_1")))
{
}

Transition_con__bxwf::~Transition_con__bxwf()
{
}

bool Transition_con__bxwf::globalGuard()
{
	return true;
}
void Transition_con__bxwf::initGlobalGuards()
{
}

void Transition_con__bxwf::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_con__bxwf::generateBindingList()
{
	TokenList* tok;
...
void Transition_con__bxwf::log(TokenList &binding)
{
}

double Transition_con__bxwf::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_con__bxwf::getFiringDelay(TokenList &binding) const
{
...
bool Transition_con__bxwf::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_con__bxwf::Timeguard(const DateTime& now)
{
	return 0.0;
}
