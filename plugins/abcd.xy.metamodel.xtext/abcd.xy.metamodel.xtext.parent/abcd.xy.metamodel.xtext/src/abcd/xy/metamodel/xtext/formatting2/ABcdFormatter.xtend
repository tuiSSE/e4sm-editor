 ...
 */
package abcd.xy.metamodel.xtext.formatting2
...
class ABcdFormatter extends AbstractFormatter2 {

	@Inject extension ABcdGrammarAccess
...
//	}
	...
	def dispatch void format(abcd.xy.metamodel.abcd.Package _package, extension IFormattableDocument doc) {
		// TODO: format HiddenRegions around keywords, attributes, cross references, etc. 
	...
	def dispatch void format(abcd.xy.metamodel.abcd.Component _component, extension IFormattableDocument doc) {
	...
	def dispatch void format(abcd.xy.metamodel.abcd.Pin _pin, extension IFormattableDocument doc) {
	...
	def dispatch void format(abcd.xy.metamodel.abcd.Connector _connector, extension IFormattableDocument doc) {
