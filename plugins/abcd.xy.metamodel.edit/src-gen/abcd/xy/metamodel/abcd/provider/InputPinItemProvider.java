...
/**
 * This is the item provider adapter for a {@link abcd.xy.metamodel.abcd.InputPin} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_InputPin_queueType_feature",
								"_UI_InputPin_type"),
						abcdPackage.Literals.INPUT_PIN__QUEUE_TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_InputPin_collect_feature",
								"_UI_InputPin_type"),
						abcdPackage.Literals.INPUT_PIN__COLLECT, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_InputPin_optional_feature",
								"_UI_InputPin_type"),
						abcdPackage.Literals.INPUT_PIN__OPTIONAL, true, false, false,
