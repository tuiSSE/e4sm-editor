 ...
 * {@link e4sm.de.metamodel.e4sm.OutputPin} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class OutputPinItemProvider extends PinItemProvider {
	...
	/**
	 * This returns OutputPin.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		final String name = outputPin.getName();
		if (name != null && name.length() > 0) {
			label = name;
		} else {
			Component component = (Component) outputPin.eContainer();
