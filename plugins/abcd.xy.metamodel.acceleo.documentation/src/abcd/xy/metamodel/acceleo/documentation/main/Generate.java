 ...
 *******************************************************************************/
package abcd.xy.metamodel.acceleo.documentation.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/abcd/xy/metamodel/acceleo/documentation/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(abcd.xy.metamodel.abcd.abcdPackage.class)) {
            resourceSet.getPackageRegistry().put(abcd.xy.metamodel.abcd.abcdPackage.eINSTANCE.getNsURI(), abcd.xy.metamodel.abcd.abcdPackage.eINSTANCE);
        }
