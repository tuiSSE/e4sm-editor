 ...
 * </p>
 * <ul>
 *   <li>{@link e4sm.de.metamodel.e4sm.impl.TypedElementImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TypedElementImpl extends NamedElementImpl implements TypedElement {
	...
	protected EClass eStaticClass() {
		return e4smPackage.Literals.TYPED_ELEMENT;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, e4smPackage.TYPED_ELEMENT__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public void setType(EDataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, e4smPackage.TYPED_ELEMENT__TYPE, oldType, type));
	}
