/************************************************************
	...
	Transition_Output__ready.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Output__ready::Transition_Output__ready(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	x_Place ( *(net->getPlace( &places, "Output_in_1"))),
	nona1_Place ( *(net->getPlace( &places, "Output_main")))
{
}

Transition_Output__ready::~Transition_Output__ready()
{
}

bool Transition_Output__ready::globalGuard()
{
	return true;
}
void Transition_Output__ready::initGlobalGuards()
{
}

void Transition_Output__ready::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Output__ready::generateBindingList()
{
	TokenList* tok;
...
void Transition_Output__ready::log(TokenList &binding)
{
}

double Transition_Output__ready::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Output__ready::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Output__ready::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Output__ready::Timeguard(const DateTime& now)
{
	return 0.0;
}
