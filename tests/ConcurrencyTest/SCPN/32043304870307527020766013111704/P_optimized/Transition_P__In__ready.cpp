/************************************************************
	...
	Transition_P__In__ready.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_P__In__ready::Transition_P__In__ready(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "P_In_executed")))
{
}

Transition_P__In__ready::~Transition_P__In__ready()
{
}

bool Transition_P__In__ready::globalGuard()
{
	return true;
}
void Transition_P__In__ready::initGlobalGuards()
{
}

void Transition_P__In__ready::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_P__In__ready::generateBindingList()
{
	TokenList* tok;
...
void Transition_P__In__ready::log(TokenList &binding)
{
}

double Transition_P__In__ready::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_P__In__ready::getFiringDelay(TokenList &binding) const
{
...
bool Transition_P__In__ready::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_P__In__ready::Timeguard(const DateTime& now)
{
	return 0.0;
}
