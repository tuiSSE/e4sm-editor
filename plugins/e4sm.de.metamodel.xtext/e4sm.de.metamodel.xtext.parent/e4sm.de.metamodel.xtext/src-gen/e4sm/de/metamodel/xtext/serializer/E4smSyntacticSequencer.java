...
public class E4smSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_InputPin___LeftCurlyBracketKeyword_6_0_RightCurlyBracketKeyword_6_5__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_InputPin___LeftCurlyBracketKeyword_6_0_RightCurlyBracketKeyword_6_5__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getInputPinAccess().getLeftCurlyBracketKeyword_6_0()), new TokenAlias(false, false, grammarAccess.getInputPinAccess().getRightCurlyBracketKeyword_6_5()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_InputPin___LeftCurlyBracketKeyword_6_0_RightCurlyBracketKeyword_6_5__q.equals(syntax))
				emit_InputPin___LeftCurlyBracketKeyword_6_0_RightCurlyBracketKeyword_6_5__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 * </pre>
	 */
	protected void emit_InputPin___LeftCurlyBracketKeyword_6_0_RightCurlyBracketKeyword_6_5__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
