/************************************************************
	...
	Transition_Binary__OOD.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Binary__OOD::Transition_Binary__OOD(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
Transition_Binary__OOD::~Transition_Binary__OOD()
{
}

bool Transition_Binary__OOD::globalGuard()
{
	return true;
}
void Transition_Binary__OOD::initGlobalGuards()
{
}

void Transition_Binary__OOD::moveTokens(TokenList &binding)
{
...

	{
		...
		// Transfering Token: 1'x(ood=true)
		{
			bool newValue_0;
			{
				// Orig Expression: 
				...
				newValue_0 = (bool)(true);
			}
			token_x->set_ood(newValue_0);
			nona1_Place.addToken(token_x);
		}
	}
}

TempBindingList* Transition_Binary__OOD::generateBindingList()
{
	TokenList* tok;
...
void Transition_Binary__OOD::log(TokenList &binding)
{
}

double Transition_Binary__OOD::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Binary__OOD::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Binary__OOD::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Binary__OOD::Timeguard(const DateTime& now)
{
	return 0.0;
}
