 ...
 * </p>
 * <ul>
 *   <li>{@link e4sm.de.metamodel.e4sm.core.ParameterizableElement#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @see e4sm.de.metamodel.e4sm.core.CorePackage#getParameterizableElement()
...
public interface ParameterizableElement extends EObject {
	 ...
	 * @see e4sm.de.metamodel.e4sm.core.CorePackage#getParameterizableElement_Parameters()
