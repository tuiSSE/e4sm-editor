 ...
 * </p>
 * <ul>
 *   <li>{@link e4sm.de.metamodel.e4sm.impl.ActorImpl#getDocumentation <em>Documentation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActorImpl extends NamedElementImpl implements Actor {
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, e4smPackage.ACTOR__DOCUMENTATION, oldDocumentation,
					documentation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case e4smPackage.ACTOR__DOCUMENTATION:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DocumentableElement.class) {
			...
			case CorePackage.DOCUMENTABLE_ELEMENT__DOCUMENTATION:
				return e4smPackage.ACTOR__DOCUMENTATION;
			default:
				return -1;
			}
		}
