/************************************************************
	...
	Transition_Binary__post__execution.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Binary__post__execution::Transition_Binary__post__execution(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "Binary_executed"))),
	nona1_Place ( *(net->getPlace( &places, "Binary_out1")))
{
}

Transition_Binary__post__execution::~Transition_Binary__post__execution()
{
}

bool Transition_Binary__post__execution::globalGuard()
{
	return true;
}
void Transition_Binary__post__execution::initGlobalGuards()
{
}

void Transition_Binary__post__execution::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Binary__post__execution::generateBindingList()
{
	TokenList* tok;
...
void Transition_Binary__post__execution::log(TokenList &binding)
{
}

double Transition_Binary__post__execution::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Binary__post__execution::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Binary__post__execution::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Binary__post__execution::Timeguard(const DateTime& now)
{
	return 0.0;
}
