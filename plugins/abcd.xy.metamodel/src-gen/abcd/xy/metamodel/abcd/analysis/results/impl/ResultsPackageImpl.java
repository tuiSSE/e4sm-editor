...
import abcd.xy.metamodel.abcd.analysis.results.AnalysisResult;
import abcd.xy.metamodel.abcd.analysis.results.Data;
import abcd.xy.metamodel.abcd.analysis.results.Diagram;
import abcd.xy.metamodel.abcd.analysis.results.Plot;
...
import abcd.xy.metamodel.abcd.analysis.results.ScalarValue;
...
public class ResultsPackageImpl extends EPackageImpl implements ResultsPackage {
	 ...
	 * @see abcd.xy.metamodel.abcd.analysis.results.ResultsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getAnalysisExecution_RunOnModel(), theabcdPackage.getModel(), null, "runOnModel", null, 0, 1,
				AnalysisExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEdaptAnnotations() {
		...
		addAnnotation(this, source, new String[] { "historyURI", "abcd.history" });
	}
