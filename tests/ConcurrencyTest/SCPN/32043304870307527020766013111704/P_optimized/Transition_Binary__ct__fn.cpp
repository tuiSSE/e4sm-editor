/************************************************************
	...
	Transition_Binary__ct__fn.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Binary__ct__fn::Transition_Binary__ct__fn(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "Binary_fn")))
{
}

Transition_Binary__ct__fn::~Transition_Binary__ct__fn()
{
}

bool Transition_Binary__ct__fn::globalGuard()
{
	return true;
}
void Transition_Binary__ct__fn::initGlobalGuards()
{
}

void Transition_Binary__ct__fn::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Binary__ct__fn::generateBindingList()
{
	TokenList* tok;
...
void Transition_Binary__ct__fn::log(TokenList &binding)
{
}

double Transition_Binary__ct__fn::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Binary__ct__fn::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Binary__ct__fn::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Binary__ct__fn::Timeguard(const DateTime& now)
{
	return 0.0;
}
