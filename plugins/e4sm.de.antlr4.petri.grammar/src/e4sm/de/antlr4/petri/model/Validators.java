	   ...
	   boolean validationFailed = timeFunction == null || timeFunction.length() < 1 ? true : false;
		if (!validationFailed) {
			...
			try {
				...
				//Check if what it was parsed is the entire input, without spaces at the beginning or the end.
				//If not, the user has inserted some extra text after the time function, such as: "EXP(1.0) asd"
