 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.core.impl.IntegerAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerAttributeImpl extends AttributeSpecificationImpl implements IntegerAttribute {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.INTEGER_ATTRIBUTE;
	}
	...
	public void setDefaultValue(int newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INTEGER_ATTRIBUTE__DEFAULT_VALUE,
