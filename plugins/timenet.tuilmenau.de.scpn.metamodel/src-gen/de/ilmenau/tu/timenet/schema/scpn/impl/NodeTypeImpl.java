 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.NodeTypeImpl#getGraphics <em>Graphics</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.NodeTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.NodeTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeTypeImpl extends MinimalEObjectImpl.Container implements NodeType {
	...
	protected EClass eStaticClass() {
		return scpnPackage.Literals.NODE_TYPE;
	}
	...
	public NotificationChain basicSetGraphics(GraphicsType newGraphics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					scpnPackage.NODE_TYPE__GRAPHICS, oldGraphics, newGraphics);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newGraphics != graphics) {
			...
			if (graphics != null)
				msgs = ((InternalEObject) graphics).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - scpnPackage.NODE_TYPE__GRAPHICS, null, msgs);
			if (newGraphics != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.NODE_TYPE__GRAPHICS, newGraphics,
					newGraphics));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.NODE_TYPE__ID, oldId, id));
	}
	...
	public void setType(Type newType) {
		...
		typeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.NODE_TYPE__TYPE, oldType, type,
					!oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, scpnPackage.NODE_TYPE__TYPE, oldType, TYPE_EDEFAULT,
					oldTypeESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case scpnPackage.NODE_TYPE__GRAPHICS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case scpnPackage.NODE_TYPE__GRAPHICS:
			return getGraphics();
		case scpnPackage.NODE_TYPE__ID:
			return getId();
		case scpnPackage.NODE_TYPE__TYPE:
			return getType();
		}
