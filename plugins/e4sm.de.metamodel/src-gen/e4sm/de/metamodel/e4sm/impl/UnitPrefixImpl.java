 ...
 * </p>
 * <ul>
 *   <li>{@link e4sm.de.metamodel.e4sm.impl.UnitPrefixImpl#getSymbol <em>Symbol</em>}</li>
 *   <li>{@link e4sm.de.metamodel.e4sm.impl.UnitPrefixImpl#getConversionFactor <em>Conversion Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitPrefixImpl extends MinimalEObjectImpl.Container implements UnitPrefix {
	...
	protected EClass eStaticClass() {
		return e4smPackage.Literals.UNIT_PREFIX;
	}
	...
	public void setSymbol(String newSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, e4smPackage.UNIT_PREFIX__SYMBOL, oldSymbol, symbol));
	}
	...
	public void setConversionFactor(int newConversionFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, e4smPackage.UNIT_PREFIX__CONVERSION_FACTOR,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case e4smPackage.UNIT_PREFIX__SYMBOL:
			return getSymbol();
		case e4smPackage.UNIT_PREFIX__CONVERSION_FACTOR:
