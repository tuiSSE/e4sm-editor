...
/**
 * This is the item provider adapter for a {@link abcd.xy.metamodel.abcd.Person} object.
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Person_surname_feature",
								"_UI_Person_type"),
						abcdPackage.Literals.PERSON__SURNAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Person_department_feature",
								"_UI_Person_type"),
						abcdPackage.Literals.PERSON__DEPARTMENT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Person_pictureFileName_feature",
								"_UI_Person_type"),
						abcdPackage.Literals.PERSON__PICTURE_FILE_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
