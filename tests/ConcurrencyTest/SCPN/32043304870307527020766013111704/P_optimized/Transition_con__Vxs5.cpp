/************************************************************
	...
	Transition_con__Vxs5.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_con__Vxs5::Transition_con__Vxs5(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "C1_out1"))),
	nona1_Place ( *(net->getPlace( &places, "A_in_1_1")))
{
}

Transition_con__Vxs5::~Transition_con__Vxs5()
{
}

bool Transition_con__Vxs5::globalGuard()
{
	return true;
}
void Transition_con__Vxs5::initGlobalGuards()
{
}

void Transition_con__Vxs5::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_con__Vxs5::generateBindingList()
{
	TokenList* tok;
...
void Transition_con__Vxs5::log(TokenList &binding)
{
}

double Transition_con__Vxs5::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_con__Vxs5::getFiringDelay(TokenList &binding) const
{
...
bool Transition_con__Vxs5::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_con__Vxs5::Timeguard(const DateTime& now)
{
	return 0.0;
}
