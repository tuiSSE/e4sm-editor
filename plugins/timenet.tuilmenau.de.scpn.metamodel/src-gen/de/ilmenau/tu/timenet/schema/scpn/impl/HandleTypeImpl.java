 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.HandleTypeImpl#getGraphics <em>Graphics</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.HandleTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HandleTypeImpl extends MinimalEObjectImpl.Container implements HandleType {
	...
	protected EClass eStaticClass() {
		return scpnPackage.Literals.HANDLE_TYPE;
	}
	...
	public NotificationChain basicSetGraphics(GraphicsType newGraphics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					scpnPackage.HANDLE_TYPE__GRAPHICS, oldGraphics, newGraphics);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newGraphics != graphics) {
			...
			if (graphics != null)
				msgs = ((InternalEObject) graphics).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - scpnPackage.HANDLE_TYPE__GRAPHICS, null, msgs);
			if (newGraphics != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.HANDLE_TYPE__GRAPHICS, newGraphics,
					newGraphics));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.HANDLE_TYPE__ID, oldId, id));
	}
