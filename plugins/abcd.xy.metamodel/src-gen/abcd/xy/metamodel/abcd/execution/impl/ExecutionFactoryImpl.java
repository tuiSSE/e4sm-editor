...
public class ExecutionFactoryImpl extends EFactoryImpl implements ExecutionFactory {
	...
	public static ExecutionFactory init() {
		try {
			ExecutionFactory theExecutionFactory = (ExecutionFactory) EPackage.Registry.INSTANCE
					.getEFactory(ExecutionPackage.eNS_URI);
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case ExecutionPackage.TIME_FUNCTIONS:
			return createTimeFunctionsFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case ExecutionPackage.TIME_FUNCTIONS:
			return convertTimeFunctionsToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public TimeFunctions createTimeFunctionsFromString(EDataType eDataType, String initialValue) {
		TimeFunctions result = TimeFunctions.get(initialValue);
		if (result == null)
	 ...
	 * @generated
	 */
	public String convertTimeFunctionsToString(EDataType eDataType, Object instanceValue) {
