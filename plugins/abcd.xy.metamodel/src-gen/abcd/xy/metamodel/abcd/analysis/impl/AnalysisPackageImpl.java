...
import abcd.xy.metamodel.abcd.analysis.EntireGraphAnalysis;
import abcd.xy.metamodel.abcd.analysis.GraphAnalysis;
import abcd.xy.metamodel.abcd.analysis.MemoryLessGraphAnalysis;
import abcd.xy.metamodel.abcd.analysis.ModelAnalysis;
import abcd.xy.metamodel.abcd.analysis.NetworkGenerator;
import abcd.xy.metamodel.abcd.analysis.PackageAnalysis;
...
import abcd.xy.metamodel.abcd.analysis.PreviousNodeGraphAnalysis;
...
import abcd.xy.metamodel.abcd.impl.abcdPackageImpl;
...
public class AnalysisPackageImpl extends EPackageImpl implements AnalysisPackage {
	 ...
	 * @see abcd.xy.metamodel.abcd.analysis.AnalysisPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static AnalysisPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(abcdPackage.eNS_URI);
		abcdPackageImpl theabcdPackage = (abcdPackageImpl) (registeredPackage instanceof abcdPackageImpl
				? registeredPackage
				: abcdPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		abcdPackage theabcdPackage = (abcdPackage) EPackage.Registry.INSTANCE.getEPackage(abcdPackage.eNS_URI);
		...
		op = initEOperation(getNetworkGenerator__GenerateNetwork__Model(), null, "generateNetwork", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, theabcdPackage.getModel(), "m", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(theGuavaPackage.getImmutableNetwork());
		g2 = createEGenericType(theabcdPackage.getComponent());
		g1.getETypeArguments().add(g2);
		g2 = createEGenericType(theabcdPackage.getConnector());
		g1.getETypeArguments().add(g2);
		initEOperation(op, g1);

		op = initEOperation(getNetworkGenerator__GenerateNetwork__Package(), null, "generateNetwork", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, theabcdPackage.getPackage(), "p", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(theGuavaPackage.getImmutableNetwork());
		g2 = createEGenericType(theabcdPackage.getComponent());
		g1.getETypeArguments().add(g2);
		g2 = createEGenericType(theabcdPackage.getConnector());
