/************************************************************
	...
	Transition_A__execution.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_A__execution::Transition_A__execution(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "A_executed")))
{
}

Transition_A__execution::~Transition_A__execution()
{
}

bool Transition_A__execution::globalGuard()
{
	return true;
}
void Transition_A__execution::initGlobalGuards()
{
}

void Transition_A__execution::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_A__execution::generateBindingList()
{
	TokenList* tok;
...
void Transition_A__execution::log(TokenList &binding)
{
}

double Transition_A__execution::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_A__execution::getFiringDelay(TokenList &binding) const
{
...
bool Transition_A__execution::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_A__execution::Timeguard(const DateTime& now)
{
	return 0.0;
}
