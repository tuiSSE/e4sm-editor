...
/**
 * This is the item provider adapter for a {@link abcd.xy.metamodel.abcd.execution.MergeNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MergeNodeItemProvider extends ExecutionElementItemProvider {
	/**
	...
	protected void addSourcesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MergeNode_sources_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MergeNode_sources_feature",
								"_UI_MergeNode_type"),
						ExecutionPackage.Literals.MERGE_NODE__SOURCES, true, false, true, null, null, null));
	}
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MergeNode_target_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MergeNode_target_feature",
								"_UI_MergeNode_type"),
						ExecutionPackage.Literals.MERGE_NODE__TARGET, true, false, true, null, null, null));
	}
