 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.ArcTypeImpl#getInscription <em>Inscription</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.ArcTypeImpl#getHandle <em>Handle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArcTypeImpl extends ConnectorTypeImpl implements ArcType {
	...
	protected EClass eStaticClass() {
		return scpnPackage.Literals.ARC_TYPE;
	}
	...
	public NotificationChain basicSetInscription(InscriptionType newInscription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					scpnPackage.ARC_TYPE__INSCRIPTION, oldInscription, newInscription);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newInscription != inscription) {
			...
			if (inscription != null)
				msgs = ((InternalEObject) inscription).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - scpnPackage.ARC_TYPE__INSCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.ARC_TYPE__INSCRIPTION, newInscription,
					newInscription));
	}
	...
	public EList<HandleType> getHandle() {
		if (handle == null) {
			handle = new EObjectContainmentEList<HandleType>(HandleType.class, this, scpnPackage.ARC_TYPE__HANDLE);
		}
		return handle;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case scpnPackage.ARC_TYPE__INSCRIPTION:
			return basicSetInscription(null, msgs);
		case scpnPackage.ARC_TYPE__HANDLE:
