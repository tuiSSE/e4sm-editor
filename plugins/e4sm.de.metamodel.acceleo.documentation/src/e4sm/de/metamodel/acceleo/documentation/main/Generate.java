 ...
 *******************************************************************************/
package e4sm.de.metamodel.acceleo.documentation.main;
...
public class Generate extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/e4sm/de/metamodel/acceleo/documentation/main/generate";
	...
	public void registerPackages(ResourceSet resourceSet) {
		...
		if (!isInWorkspace(e4sm.de.metamodel.e4sm.e4smPackage.class)) {
			resourceSet.getPackageRegistry().put(e4sm.de.metamodel.e4sm.e4smPackage.eINSTANCE.getNsURI(),
					e4sm.de.metamodel.e4sm.e4smPackage.eINSTANCE);
		}
	...
	public void registerResourceFactories(ResourceSet resourceSet) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("e4smcode",
