/************************************************************
	...
	Transition_con__uOSv.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_con__uOSv::Transition_con__uOSv(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "Binary_out1"))),
	nona1_Place ( *(net->getPlace( &places, "A3_in_1")))
{
}

Transition_con__uOSv::~Transition_con__uOSv()
{
}

bool Transition_con__uOSv::globalGuard()
{
	return true;
}
void Transition_con__uOSv::initGlobalGuards()
{
}

void Transition_con__uOSv::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_con__uOSv::generateBindingList()
{
	TokenList* tok;
...
void Transition_con__uOSv::log(TokenList &binding)
{
}

double Transition_con__uOSv::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_con__uOSv::getFiringDelay(TokenList &binding) const
{
...
bool Transition_con__uOSv::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_con__uOSv::Timeguard(const DateTime& now)
{
	return 0.0;
}
