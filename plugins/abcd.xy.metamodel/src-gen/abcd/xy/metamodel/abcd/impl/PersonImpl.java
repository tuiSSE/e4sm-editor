 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.PersonImpl#getSurname <em>Surname</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.PersonImpl#getDepartment <em>Department</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.PersonImpl#getPictureFileName <em>Picture File Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends HumanImpl implements Person {
	...
	protected EClass eStaticClass() {
		return abcdPackage.Literals.PERSON;
	}
	...
	public void setSurname(String newSurname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.PERSON__SURNAME, oldSurname, surname));
	}
	...
	public void setDepartment(String newDepartment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.PERSON__DEPARTMENT, oldDepartment,
					department));
	}
	...
	public void setPictureFileName(String newPictureFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.PERSON__PICTURE_FILE_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case abcdPackage.PERSON__SURNAME:
			return getSurname();
		case abcdPackage.PERSON__DEPARTMENT:
			return getDepartment();
		case abcdPackage.PERSON__PICTURE_FILE_NAME:
