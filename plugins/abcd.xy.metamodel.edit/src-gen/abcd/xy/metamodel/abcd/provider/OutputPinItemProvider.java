...
/**
 * This is the item provider adapter for a {@link abcd.xy.metamodel.abcd.OutputPin} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_OutputPin_amplify_feature",
								"_UI_OutputPin_type"),
						abcdPackage.Literals.OUTPUT_PIN__AMPLIFY, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_OutputPin_outputUncertainty_feature",
								"_UI_OutputPin_type"),
						abcdPackage.Literals.OUTPUT_PIN__OUTPUT_UNCERTAINTY, true, false, false,
