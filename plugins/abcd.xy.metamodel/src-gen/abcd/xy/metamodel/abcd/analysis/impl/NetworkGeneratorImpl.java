...
public class NetworkGeneratorImpl extends MinimalEObjectImpl.Container implements NetworkGenerator {
	 ...
	 */
	@Override
	public ImmutableNetwork<Component, Connector> generateNetwork(abcd.xy.metamodel.abcd.Package p) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case AnalysisPackage.NETWORK_GENERATOR___GENERATE_NETWORK__PACKAGE:
			return generateNetwork((abcd.xy.metamodel.abcd.Package) arguments.get(0));
		}
