 ...
 * </p>
 * <ul>
 *   <li>{@link e4sm.de.metamodel.e4sm.types.impl.LiteralIntegerImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralIntegerImpl extends LiteralSpecificationImpl implements LiteralInteger {
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.LITERAL_INTEGER;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.LITERAL_INTEGER__VALUE, oldValue,
					value));
	}
