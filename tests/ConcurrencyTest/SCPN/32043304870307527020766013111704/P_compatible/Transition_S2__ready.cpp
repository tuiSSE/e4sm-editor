/************************************************************
	...
	Transition_S2__ready.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_S2__ready::Transition_S2__ready(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "S2_executed")))
{
}

Transition_S2__ready::~Transition_S2__ready()
{
}

bool Transition_S2__ready::globalGuard()
{
	return true;
}
void Transition_S2__ready::initGlobalGuards()
{
}

void Transition_S2__ready::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_S2__ready::generateBindingList()
{
	TokenList* tok;
...
void Transition_S2__ready::log(TokenList &binding)
{
}

double Transition_S2__ready::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_S2__ready::getFiringDelay(TokenList &binding) const
{
...
bool Transition_S2__ready::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_S2__ready::Timeguard(const DateTime& now)
{
	return 0.0;
}
