 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.PinImpl#isGatewayPin <em>Gateway Pin</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.PinImpl#isStream <em>Stream</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.PinImpl#getRaceSemantic <em>Race Semantic</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PinImpl extends DataNodeImpl implements Pin {
	...
	protected EClass eStaticClass() {
		return abcdPackage.Literals.PIN;
	}
	...
	public void setStream(boolean newStream) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.PIN__STREAM, oldStream, stream));
	}
	...
	public void setRaceSemantic(RaceSemantic newRaceSemantic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.PIN__RACE_SEMANTIC, oldRaceSemantic,
					raceSemantic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case abcdPackage.PIN__GATEWAY_PIN:
			return isGatewayPin();
		case abcdPackage.PIN__STREAM:
			return isStream();
		case abcdPackage.PIN__RACE_SEMANTIC:
