 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.NetTypeImpl#isGridActive <em>Grid Active</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.NetTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.NetTypeImpl#getNetclass <em>Netclass</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.NetTypeImpl#isSharpEdges <em>Sharp Edges</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetTypeImpl extends MinimalEObjectImpl.Container implements NetType {
	...
	protected EClass eStaticClass() {
		return scpnPackage.Literals.NET_TYPE;
	}
	...
	public void setGridActive(boolean newGridActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.NET_TYPE__GRID_ACTIVE, oldGridActive,
	...
	public void unsetGridActive() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, scpnPackage.NET_TYPE__GRID_ACTIVE, oldGridActive,
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.NET_TYPE__ID, oldId, id));
	}
	...
	public void setNetclass(String newNetclass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.NET_TYPE__NETCLASS, oldNetclass,
					netclass));
	}
	...
	public void setSharpEdges(boolean newSharpEdges) {
		...
		sharpEdgesESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.NET_TYPE__SHARP_EDGES, oldSharpEdges,
	...
	public void unsetSharpEdges() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, scpnPackage.NET_TYPE__SHARP_EDGES, oldSharpEdges,
