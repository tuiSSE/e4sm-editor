/************************************************************
	...
	Transition_Act1__execution.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Act1__execution::Transition_Act1__execution(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "Act1_executed")))
{
}

Transition_Act1__execution::~Transition_Act1__execution()
{
}

bool Transition_Act1__execution::globalGuard()
{
	return true;
}
void Transition_Act1__execution::initGlobalGuards()
{
}

void Transition_Act1__execution::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Act1__execution::generateBindingList()
{
	TokenList* tok;
...
void Transition_Act1__execution::log(TokenList &binding)
{
}

double Transition_Act1__execution::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Act1__execution::getFiringDelay(TokenList &binding) const
{
...
bool Transition_Act1__execution::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Act1__execution::Timeguard(const DateTime& now)
{
	return 0.0;
}
