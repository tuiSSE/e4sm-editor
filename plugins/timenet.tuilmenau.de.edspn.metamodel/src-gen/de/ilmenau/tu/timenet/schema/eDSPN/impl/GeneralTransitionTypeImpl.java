...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>General Transition Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.GeneralTransitionTypeImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link de.ilmenau.tu.timenet.schema.eDSPN.impl.GeneralTransitionTypeImpl#getPreemptionPolicy <em>Preemption Policy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneralTransitionTypeImpl extends TransitionTypeImpl implements GeneralTransitionType {
	/**
	 ...
	 * @ordered
	 */
	protected static final String DELAY_EDEFAULT = "UNIFORM(0.0,1.0);";
	 ...
	 * @generated
	 */
	protected GeneralTransitionTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EDSPNPackage.Literals.GENERAL_TRANSITION_TYPE;
	}
	...
	public void setDelay(String newDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDSPNPackage.GENERAL_TRANSITION_TYPE__DELAY, oldDelay,
					delay, !oldDelayESet));
	}
	...
	public void unsetDelay() {
		...
		delayESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EDSPNPackage.GENERAL_TRANSITION_TYPE__DELAY,
	...
	public void setPreemptionPolicy(PreemptionPolicyType newPreemptionPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EDSPNPackage.GENERAL_TRANSITION_TYPE__PREEMPTION_POLICY, oldPreemptionPolicy, preemptionPolicy,
	...
	public void unsetPreemptionPolicy() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					EDSPNPackage.GENERAL_TRANSITION_TYPE__PREEMPTION_POLICY, oldPreemptionPolicy,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EDSPNPackage.GENERAL_TRANSITION_TYPE__DELAY:
			return getDelay();
		case EDSPNPackage.GENERAL_TRANSITION_TYPE__PREEMPTION_POLICY:
