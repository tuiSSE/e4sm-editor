 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.DataNodeImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.DataNodeImpl#getDocumentation <em>Documentation</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DataNodeImpl extends TypedElementImpl implements DataNode {
	...
	protected EClass eStaticClass() {
		return abcdPackage.Literals.DATA_NODE;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this,
					abcdPackage.DATA_NODE__PARAMETERS);
		}
		return parameters;
	}
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.DATA_NODE__DOCUMENTATION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case abcdPackage.DATA_NODE__PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case abcdPackage.DATA_NODE__DOCUMENTATION:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ParameterizableElement.class) {
			...
			case AnalysisPackage.PARAMETERIZABLE_ELEMENT__PARAMETERS:
				return abcdPackage.DATA_NODE__PARAMETERS;
			default:
				return -1;
			}
		}
		if (baseClass == DocumentableElement.class) {
			...
			case CorePackage.DOCUMENTABLE_ELEMENT__DOCUMENTATION:
				return abcdPackage.DATA_NODE__DOCUMENTATION;
			default:
				return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case abcdPackage.DATA_NODE___COMPUTE_NAME:
			return computeName();
		case abcdPackage.DATA_NODE___GET_OUTGOING_CONNECTORS:
			return getOutgoingConnectors();
		case abcdPackage.DATA_NODE___GET_INCOMING_CONNECTORS:
