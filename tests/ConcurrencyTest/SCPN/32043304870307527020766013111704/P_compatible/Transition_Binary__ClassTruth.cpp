/************************************************************
	...
	Transition_Binary__ClassTruth.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Binary__ClassTruth::Transition_Binary__ClassTruth(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
...
,
	...
	nona1_Place ( *(net->getPlace( &places, "Binary_ct")))
{
}

Transition_Binary__ClassTruth::~Transition_Binary__ClassTruth()
{
}

bool Transition_Binary__ClassTruth::globalGuard()
{
	return true;
}
void Transition_Binary__ClassTruth::initGlobalGuards()
{
}

void Transition_Binary__ClassTruth::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Binary__ClassTruth::generateBindingList()
{
	TokenList* tok;
...
void Transition_Binary__ClassTruth::log(TokenList &binding)
{
}

double Transition_Binary__ClassTruth::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Binary__ClassTruth::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Binary__ClassTruth::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Binary__ClassTruth::Timeguard(const DateTime& now)
{
	return 0.0;
}
