/************************************************************
	...
	Transition_con__WnTU.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_con__WnTU::Transition_con__WnTU(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "S3_out1"))),
	nona1_Place ( *(net->getPlace( &places, "Binary_in_1")))
{
}

Transition_con__WnTU::~Transition_con__WnTU()
{
}

bool Transition_con__WnTU::globalGuard()
{
	return true;
}
void Transition_con__WnTU::initGlobalGuards()
{
}

void Transition_con__WnTU::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_con__WnTU::generateBindingList()
{
	TokenList* tok;
...
void Transition_con__WnTU::log(TokenList &binding)
{
}

double Transition_con__WnTU::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_con__WnTU::getFiringDelay(TokenList &binding) const
{
...
bool Transition_con__WnTU::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_con__WnTU::Timeguard(const DateTime& now)
{
	return 0.0;
}
