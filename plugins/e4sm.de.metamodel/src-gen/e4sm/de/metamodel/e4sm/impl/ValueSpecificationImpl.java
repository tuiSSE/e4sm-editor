...
public abstract class ValueSpecificationImpl extends TypedElementImpl implements ValueSpecification {
	...
	protected EClass eStaticClass() {
		return e4smPackage.Literals.VALUE_SPECIFICATION;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case e4smPackage.VALUE_SPECIFICATION___BOOLEAN_VALUE:
			return booleanValue();
		case e4smPackage.VALUE_SPECIFICATION___INTEGER_VALUE:
			return integerValue();
		case e4smPackage.VALUE_SPECIFICATION___IS_COMPUTABLE:
			return isComputable();
		}
