 ...
 * </p>
 * <ul>
 *   <li>{@link e4sm.de.metamodel.e4sm.types.impl.LiteralBooleanImpl#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralBooleanImpl extends LiteralSpecificationImpl implements LiteralBoolean {
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.LITERAL_BOOLEAN;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.LITERAL_BOOLEAN__VALUE, oldValue,
					value));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case TypesPackage.LITERAL_BOOLEAN___GET_VALUE:
			return getValue();
		}
