...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>E4SM Element Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see e4sm.de.metamodel.e4sm.e4smPackage#getE4SMElementType()
 * @model
 * @generated
 */
public enum E4SMElementType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>E4SM Element Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final E4SMElementType[] VALUES_ARRAY = new E4SMElementType[] { COMPONENT, CONNECTOR,
			PHYSICAL_CONNECTOR, SOFTWARE_CONNECTOR, PIN, INPUT_PIN, OUTPUT_PIN, };

	/**
	 * A public read-only list of all the '<em><b>E4SM Element Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<E4SMElementType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>E4SM Element Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static E4SMElementType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			E4SMElementType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>E4SM Element Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static E4SMElementType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			E4SMElementType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>E4SM Element Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static E4SMElementType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private E4SMElementType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
