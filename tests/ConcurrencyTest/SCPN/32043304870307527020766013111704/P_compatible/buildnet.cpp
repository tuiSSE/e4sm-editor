...
#include "Transition_P__Out__ready.h"
...
#include "Transition_A3__ready.h"
#include "Transition_Binary__post__execution.h"
#include "Transition_Binary__ready.h"
...
void ImplementedNetClass::buildNet()
{
	...
	//
	Place *A__main;
	A__main = new Place(11, "A_main", this, false, (unsigned int)(0.0));
	A__main->setWatch(false);
	addPlace(A__main);
	...
	//
	Place *A__in__1;
	A__in__1 = new Place(12, "A_in_1", this, false, (unsigned int)(0.0));
	...
	//
	Place *A__in__1__1;
	A__in__1__1 = new Place(13, "A_in_1_1", this, false, (unsigned int)(0.0));
	...
	//
	Place *A__in__2__1;
	A__in__2__1 = new Place(14, "A_in_2_1", this, false, (unsigned int)(0.0));
	...
	P__In__executed = new Place(15, "P_In_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__In__out1;
	P__In__out1 = new Place(16, "P_In_out1", this, false, (unsigned int)(0.0));
	...
	P__Out__executed = new Place(17, "P_Out_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__Out__main;
	P__Out__main = new Place(18, "P_Out_main", this, false, (unsigned int)(0.0));
	P__Out__main->setWatch(false);
	addPlace(P__Out__main);

	//
	// ---- Place 'P_Out_in_1' ----
	//
	Place *P__Out__in__1;
	P__Out__in__1 = new Place(19, "P_Out_in_1", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__executed;
	P__executed = new Place(20, "P_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__main;
	P__main = new Place(21, "P_main", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__in__1;
	P__in__1 = new Place(22, "P_in_1", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__in__2;
	P__in__2 = new Place(23, "P_in_2", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__out1;
	P__out1 = new Place(24, "P_out1", this, false, (unsigned int)(0.0));
	...
	//
	Place *P__out2;
	P__out2 = new Place(25, "P_out2", this, false, (unsigned int)(0.0));
	...
	//
	Place *S1__executed;
	S1__executed = new Place(26, "S1_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *S1__out1;
	S1__out1 = new Place(27, "S1_out1", this, false, (unsigned int)(0.0));
	...
	//
	Place *S2__executed;
	S2__executed = new Place(28, "S2_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *S2__out1;
	S2__out1 = new Place(29, "S2_out1", this, false, (unsigned int)(0.0));
	...
	Act1__executed = new Place(30, "Act1_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *Act1__main;
	Act1__main = new Place(31, "Act1_main", this, false, (unsigned int)(0.0));
	Act1__main->setWatch(false);
	addPlace(Act1__main);
	...
	//
	Place *Act1__in__1;
	Act1__in__1 = new Place(32, "Act1_in_1", this, false, (unsigned int)(0.0));
	...
	Act2__executed = new Place(33, "Act2_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *Act2__main;
	Act2__main = new Place(34, "Act2_main", this, false, (unsigned int)(0.0));
	Act2__main->setWatch(false);
	addPlace(Act2__main);
	...
	//
	Place *Act2__in__1;
	Act2__in__1 = new Place(35, "Act2_in_1", this, false, (unsigned int)(0.0));
	...
	//
	Place *S3__executed;
	S3__executed = new Place(36, "S3_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *S3__out1;
	S3__out1 = new Place(37, "S3_out1", this, false, (unsigned int)(0.0));
	...
	//
	Place *A3__executed;
	A3__executed = new Place(38, "A3_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *A3__main;
	A3__main = new Place(39, "A3_main", this, false, (unsigned int)(0.0));
	A3__main->setWatch(false);
	addPlace(A3__main);
	...
	//
	Place *A3__in__1;
	A3__in__1 = new Place(40, "A3_in_1", this, false, (unsigned int)(0.0));
	...
	Binary__executed = new Place(41, "Binary_executed", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__main;
	Binary__main = new Place(42, "Binary_main", this, false, (unsigned int)(0.0));
	Binary__main->setWatch(false);
	addPlace(Binary__main);

	//
	// ---- Place 'Binary_in_1' ----
	//
	Place *Binary__in__1;
	Binary__in__1 = new Place(43, "Binary_in_1", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__out1;
	Binary__out1 = new Place(44, "Binary_out1", this, false, (unsigned int)(0.0));
	...
	Binary__in__data = new Place(45, "Binary_in_data", this, false, (unsigned int)(0.0));
	...
	Binary__data__gen = new Place(46, "Binary_data_gen", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__ct;
	Binary__ct = new Place(47, "Binary_ct", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__cf;
	Binary__cf = new Place(48, "Binary_cf", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__tp;
	Binary__tp = new Place(49, "Binary_tp", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__fn;
	Binary__fn = new Place(50, "Binary_fn", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__tn;
	Binary__tn = new Place(51, "Binary_tn", this, false, (unsigned int)(0.0));
	...
	//
	Place *Binary__fp;
	Binary__fp = new Place(52, "Binary_fp", this, false, (unsigned int)(0.0));
	...
	places_A__execution.insert(make_pair(string("A_main"),string("A_main")));
	...
	places_P__Out__execution.insert(make_pair(string("P_Out_main"),string("P_Out_main")));
	...
	places_Act1__execution.insert(make_pair(string("Act1_main"),string("Act1_main")));
	...
	places_Act2__execution.insert(make_pair(string("Act2_main"),string("Act2_main")));
	...
	places_A3__execution.insert(make_pair(string("A3_main"),string("A3_main")));
	...
	places_Binary__execution.insert(make_pair(string("Binary_main"),string("Binary_main")));
	...
	// ---- Transition 'A_ready' ----
	//
	PlaceIdentMap places_A__ready;
	places_A__ready.insert(make_pair(string("A_in_1"),string("A_in_1")));
	places_A__ready.insert(make_pair(string("A_main"),string("A_main")));

	Transition *A__ready;
	A__ready = new Transition_A__ready(28, "A_ready", this, places_A__ready, "", 1.0, (int)1.0, false, false, false, false);

	A__ready->setDisplaying(false);
	A__ready->setWatch(false);
	A__ready->setImmediate(true);
	A__ready->setLogfile("", "");
	addTransition(A__ready);
	...
	A__in__1__merge = new Transition_A__in__1__merge(29, "A_in_1_merge", this, places_A__in__1__merge, "", 1.0, (int)1.0, false, false, false, false);
	...
	P__In__post__execution = new Transition_P__In__post__execution(30, "P_In_post_execution", this, places_P__In__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	P__Out__post__execution = new Transition_P__Out__post__execution(31, "P_Out_post_execution", this, places_P__Out__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	//
	// ---- Transition 'P_Out_ready' ----
	//
	PlaceIdentMap places_P__Out__ready;
	places_P__Out__ready.insert(make_pair(string("P_Out_in_1"),string("P_Out_in_1")));
	places_P__Out__ready.insert(make_pair(string("P_Out_main"),string("P_Out_main")));

	Transition *P__Out__ready;
	P__Out__ready = new Transition_P__Out__ready(32, "P_Out_ready", this, places_P__Out__ready, "", 1.0, (int)1.0, false, false, false, false);

	P__Out__ready->setDisplaying(false);
	P__Out__ready->setWatch(false);
	P__Out__ready->setImmediate(true);
	P__Out__ready->setLogfile("", "");
	addTransition(P__Out__ready);
	...
	P__post__execution = new Transition_P__post__execution(33, "P_post_execution", this, places_P__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	Transition *P__ready;
	P__ready = new Transition_P__ready(34, "P_ready", this, places_P__ready, "", 1.0, (int)1.0, false, false, false, false);
	...
	S1__post__execution = new Transition_S1__post__execution(35, "S1_post_execution", this, places_S1__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	S2__post__execution = new Transition_S2__post__execution(36, "S2_post_execution", this, places_S2__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	Act1__post__execution = new Transition_Act1__post__execution(37, "Act1_post_execution", this, places_Act1__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	//
	// ---- Transition 'Act1_ready' ----
	//
	PlaceIdentMap places_Act1__ready;
	places_Act1__ready.insert(make_pair(string("Act1_in_1"),string("Act1_in_1")));
	places_Act1__ready.insert(make_pair(string("Act1_main"),string("Act1_main")));

	Transition *Act1__ready;
	Act1__ready = new Transition_Act1__ready(38, "Act1_ready", this, places_Act1__ready, "", 1.0, (int)1.0, false, false, false, false);

	Act1__ready->setDisplaying(false);
	Act1__ready->setWatch(false);
	Act1__ready->setImmediate(true);
	Act1__ready->setLogfile("", "");
	addTransition(Act1__ready);
	...
	Act2__post__execution = new Transition_Act2__post__execution(39, "Act2_post_execution", this, places_Act2__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	//
	// ---- Transition 'Act2_ready' ----
	//
	PlaceIdentMap places_Act2__ready;
	places_Act2__ready.insert(make_pair(string("Act2_in_1"),string("Act2_in_1")));
	places_Act2__ready.insert(make_pair(string("Act2_main"),string("Act2_main")));

	Transition *Act2__ready;
	Act2__ready = new Transition_Act2__ready(40, "Act2_ready", this, places_Act2__ready, "", 1.0, (int)1.0, false, false, false, false);

	Act2__ready->setDisplaying(false);
	Act2__ready->setWatch(false);
	Act2__ready->setImmediate(true);
	Act2__ready->setLogfile("", "");
	addTransition(Act2__ready);
	...
	S3__post__execution = new Transition_S3__post__execution(41, "S3_post_execution", this, places_S3__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	A3__post__execution = new Transition_A3__post__execution(42, "A3_post_execution", this, places_A3__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	// ---- Transition 'A3_ready' ----
	//
	PlaceIdentMap places_A3__ready;
	places_A3__ready.insert(make_pair(string("A3_in_1"),string("A3_in_1")));
	places_A3__ready.insert(make_pair(string("A3_main"),string("A3_main")));

	Transition *A3__ready;
	A3__ready = new Transition_A3__ready(43, "A3_ready", this, places_A3__ready, "", 1.0, (int)1.0, false, false, false, false);

	A3__ready->setDisplaying(false);
	A3__ready->setWatch(false);
	A3__ready->setImmediate(true);
	A3__ready->setLogfile("", "");
	addTransition(A3__ready);
	...
	Binary__post__execution = new Transition_Binary__post__execution(44, "Binary_post_execution", this, places_Binary__post__execution, "", 1.0, (int)1.0, false, false, false, false);
	...
	//
	// ---- Transition 'Binary_ready' ----
	//
	PlaceIdentMap places_Binary__ready;
	places_Binary__ready.insert(make_pair(string("Binary_in_1"),string("Binary_in_1")));
	places_Binary__ready.insert(make_pair(string("Binary_main"),string("Binary_main")));

	Transition *Binary__ready;
	Binary__ready = new Transition_Binary__ready(45, "Binary_ready", this, places_Binary__ready, "", 1.0, (int)1.0, false, false, false, false);

	Binary__ready->setDisplaying(false);
	Binary__ready->setWatch(false);
	Binary__ready->setImmediate(true);
	Binary__ready->setLogfile("", "");
	addTransition(Binary__ready);
	...
	Binary__not__OOD = new Transition_Binary__not__OOD(46, "Binary_not_OOD", this, places_Binary__not__OOD, "", 1.0, (int)1.0, false, false, false, false);
	...
	Binary__OOD = new Transition_Binary__OOD(47, "Binary_OOD", this, places_Binary__OOD, "", 0.0, (int)1.0, false, false, false, false);
	...
	Binary__ClassTruth = new Transition_Binary__ClassTruth(48, "Binary_ClassTruth", this, places_Binary__ClassTruth, "", 0.9688249400479616, (int)1.0, false, false, false, false);
	...
	Binary__ClassOther = new Transition_Binary__ClassOther(49, "Binary_ClassOther", this, places_Binary__ClassOther, "", 0.031175059952038398, (int)1.0, false, false, false, false);
	...
	Binary__ct__tp = new Transition_Binary__ct__tp(50, "Binary_ct_tp", this, places_Binary__ct__tp, "", 0.9900990099009901, (int)1.0, false, false, false, false);
	...
	Binary__ct__fn = new Transition_Binary__ct__fn(51, "Binary_ct_fn", this, places_Binary__ct__fn, "", 0.00990099009900991, (int)1.0, false, false, false, false);
	...
	Binary____cf__tn = new Transition_Binary____cf__tn(52, "Binary__cf_tn", this, places_Binary____cf__tn, "", 0.6153846153846154, (int)1.0, false, false, false, false);
	...
	Binary__cf__fp = new Transition_Binary__cf__fp(53, "Binary_cf_fp", this, places_Binary__cf__fp, "", 0.3846153846153846, (int)1.0, false, false, false, false);
	...
	linkPlaceToTransition("A_in_1", "A_ready", 1);
	linkTransitionToPlace("A_ready", "A_main", 1);
	...
	linkPlaceToTransition("P_Out_in_1", "P_Out_ready", 1);
	linkTransitionToPlace("P_Out_ready", "P_Out_main", 1);
	...
	linkPlaceToTransition("Act1_in_1", "Act1_ready", 1);
	linkTransitionToPlace("Act1_ready", "Act1_main", 1);
	linkPlaceToTransition("Act2_executed", "Act2_post_execution", 1);
	linkTransitionToPlace("Act2_post_execution", "P_thread_pool", 1);
	linkPlaceToTransition("Act2_in_1", "Act2_ready", 1);
	linkTransitionToPlace("Act2_ready", "Act2_main", 1);
	...
	linkPlaceToTransition("A3_in_1", "A3_ready", 1);
	linkTransitionToPlace("A3_ready", "A3_main", 1);
	linkPlaceToTransition("Binary_executed", "Binary_post_execution", 1);
	linkTransitionToPlace("Binary_post_execution", "Binary_out1", 1);
	linkPlaceToTransition("Binary_in_1", "Binary_ready", 1);
	linkTransitionToPlace("Binary_ready", "Binary_main", 1);
	...
	// ---- Measure 'fsdf' ----
	//
	measure_fsdf = new MeasureObj_fsdf(this);
	Binary__ct__tp->addMeasure(measure_fsdf);
	addMeasure(measure_fsdf);

	//
	// ---- Measure 'PlaceTP' ----
	//
	measure_PlaceTP = new MeasureObj_PlaceTP(this);
	Binary__tp->addMeasure(measure_PlaceTP);
	addMeasure(measure_PlaceTP);
