 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.OutputPinImpl#getAmplify <em>Amplify</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.OutputPinImpl#getOutputUncertainty <em>Output Uncertainty</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputPinImpl extends PinImpl implements OutputPin {
	...
	protected EClass eStaticClass() {
		return abcdPackage.Literals.OUTPUT_PIN;
	}
	...
	public void setAmplify(int newAmplify) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.OUTPUT_PIN__AMPLIFY, oldAmplify,
					amplify));
	}
	...
	public void setOutputUncertainty(double newOutputUncertainty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.OUTPUT_PIN__OUTPUT_UNCERTAINTY,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case abcdPackage.OUTPUT_PIN__AMPLIFY:
			return getAmplify();
		case abcdPackage.OUTPUT_PIN__OUTPUT_UNCERTAINTY:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case abcdPackage.OUTPUT_PIN___COMPUTE_NAME:
			return computeName();
		}
