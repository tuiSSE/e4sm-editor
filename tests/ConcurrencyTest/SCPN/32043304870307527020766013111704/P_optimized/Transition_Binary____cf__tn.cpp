/************************************************************
	...
	Transition_Binary____cf__tn.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Binary____cf__tn::Transition_Binary____cf__tn(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "Binary_cf"))),
	nona1_Place ( *(net->getPlace( &places, "Binary_tn")))
{
}

Transition_Binary____cf__tn::~Transition_Binary____cf__tn()
{
}

bool Transition_Binary____cf__tn::globalGuard()
{
	return true;
}
void Transition_Binary____cf__tn::initGlobalGuards()
{
}

void Transition_Binary____cf__tn::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Binary____cf__tn::generateBindingList()
{
	TokenList* tok;
...
void Transition_Binary____cf__tn::log(TokenList &binding)
{
}

double Transition_Binary____cf__tn::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Binary____cf__tn::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Binary____cf__tn::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Binary____cf__tn::Timeguard(const DateTime& now)
{
	return 0.0;
}
