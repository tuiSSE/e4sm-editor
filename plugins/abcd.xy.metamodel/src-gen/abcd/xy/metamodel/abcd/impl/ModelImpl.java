...
import abcd.xy.metamodel.abcd.util.abcdValidator;
 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getPackages <em>Packages</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getActors <em>Actors</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getPersonsPicturesPath <em>Persons Pictures Path</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getVariants <em>Variants</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.impl.ModelImpl#getImports <em>Imports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends NamedElementImpl implements Model {
	...
	protected EClass eStaticClass() {
		return abcdPackage.Literals.MODEL;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, abcdPackage.MODEL__PARAMETERS);
		}
		return parameters;
	}
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.MODEL__DOCUMENTATION, oldDocumentation,
					documentation));
	}
	...
	public EList<abcd.xy.metamodel.abcd.Package> getPackages() {
		if (packages == null) {
			packages = new EObjectContainmentEList<abcd.xy.metamodel.abcd.Package>(abcd.xy.metamodel.abcd.Package.class,
					this, abcdPackage.MODEL__PACKAGES);
		}
		return packages;
	}
	...
	public EList<Actor> getActors() {
		if (actors == null) {
			actors = new EObjectContainmentEList<Actor>(Actor.class, this, abcdPackage.MODEL__ACTORS);
		}
		return actors;
	}
	...
	public void setPersonsPicturesPath(String newPersonsPicturesPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, abcdPackage.MODEL__PERSONS_PICTURES_PATH,
	...
	public EList<Variant> getVariants() {
		if (variants == null) {
			variants = new EObjectContainmentEList<Variant>(Variant.class, this, abcdPackage.MODEL__VARIANTS);
		}
		return variants;
	}
	...
	public EList<Import> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<Import>(Import.class, this, abcdPackage.MODEL__IMPORTS);
		}
		return imports;
	}
	...
	public boolean isPersonPicturePathValid(DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (validationFailed || (uri != null && !Files.isDirectory(p))) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, abcdValidator.DIAGNOSTIC_SOURCE,
						abcdValidator.MODEL__IS_PERSON_PICTURE_PATH_VALID,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case abcdPackage.MODEL__PARAMETERS:
			return ((InternalEList<?>) getParameters()).basicRemove(otherEnd, msgs);
		case abcdPackage.MODEL__PACKAGES:
			return ((InternalEList<?>) getPackages()).basicRemove(otherEnd, msgs);
		case abcdPackage.MODEL__ACTORS:
			return ((InternalEList<?>) getActors()).basicRemove(otherEnd, msgs);
		case abcdPackage.MODEL__VARIANTS:
			return ((InternalEList<?>) getVariants()).basicRemove(otherEnd, msgs);
		case abcdPackage.MODEL__TYPES:
			return ((InternalEList<?>) getTypes()).basicRemove(otherEnd, msgs);
		case abcdPackage.MODEL__IMPORTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case abcdPackage.MODEL__DOCUMENTATION:
			return getDocumentation();
		case abcdPackage.MODEL__PACKAGES:
			return getPackages();
		case abcdPackage.MODEL__ACTORS:
			return getActors();
		case abcdPackage.MODEL__PERSONS_PICTURES_PATH:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ParameterizableElement.class) {
			...
			case AnalysisPackage.PARAMETERIZABLE_ELEMENT__PARAMETERS:
				return abcdPackage.MODEL__PARAMETERS;
			default:
				return -1;
			}
		}
		if (baseClass == DocumentableElement.class) {
			...
			case CorePackage.DOCUMENTABLE_ELEMENT__DOCUMENTATION:
				return abcdPackage.MODEL__DOCUMENTATION;
			default:
				return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case abcdPackage.MODEL___IS_PERSON_PICTURE_PATH_VALID__DIAGNOSTICCHAIN_MAP:
