...
import abcd.xy.metamodel.abcd.core.impl.ElementImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.analysis.impl.ParameterImpl#getParameterDefinition <em>Parameter Definition</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.analysis.impl.ParameterImpl#getAppliesOnlyOnVariants <em>Applies Only On Variants</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.analysis.impl.ParameterImpl#getDoesNotApplyOnVariants <em>Does Not Apply On Variants</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.analysis.impl.ParameterImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link abcd.xy.metamodel.abcd.analysis.impl.ParameterImpl#getCurrentValue <em>Current Value</em>}</li>
 * </ul>
 *
 * @generated
 */
