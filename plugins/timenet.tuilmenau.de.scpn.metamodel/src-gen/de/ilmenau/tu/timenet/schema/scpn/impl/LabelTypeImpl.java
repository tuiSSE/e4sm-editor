 ...
 * </p>
 * <ul>
 *   <li>{@link de.ilmenau.tu.timenet.schema.scpn.impl.LabelTypeImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabelTypeImpl extends TextTypeImpl implements LabelType {
	...
	protected EClass eStaticClass() {
		return scpnPackage.Literals.LABEL_TYPE;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, scpnPackage.LABEL_TYPE__TEXT, oldText, text,
					!oldTextESet));
	}
	...
	public void unsetText() {
		...
		textESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, scpnPackage.LABEL_TYPE__TEXT, oldText,
