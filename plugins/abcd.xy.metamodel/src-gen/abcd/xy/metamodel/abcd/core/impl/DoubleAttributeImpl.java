 ...
 * </p>
 * <ul>
 *   <li>{@link abcd.xy.metamodel.abcd.core.impl.DoubleAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleAttributeImpl extends AttributeSpecificationImpl implements DoubleAttribute {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.DOUBLE_ATTRIBUTE;
	}
	...
	public void setDefaultValue(double newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DOUBLE_ATTRIBUTE__DEFAULT_VALUE,
