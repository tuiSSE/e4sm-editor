/************************************************************
	...
	Transition_con__Q2pv.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_con__Q2pv::Transition_con__Q2pv(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "S2_out1"))),
	nona1_Place ( *(net->getPlace( &places, "P_in_2")))
{
}

Transition_con__Q2pv::~Transition_con__Q2pv()
{
}

bool Transition_con__Q2pv::globalGuard()
{
	return true;
}
void Transition_con__Q2pv::initGlobalGuards()
{
}

void Transition_con__Q2pv::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_con__Q2pv::generateBindingList()
{
	TokenList* tok;
...
void Transition_con__Q2pv::log(TokenList &binding)
{
}

double Transition_con__Q2pv::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_con__Q2pv::getFiringDelay(TokenList &binding) const
{
...
bool Transition_con__Q2pv::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_con__Q2pv::Timeguard(const DateTime& now)
{
	return 0.0;
}
