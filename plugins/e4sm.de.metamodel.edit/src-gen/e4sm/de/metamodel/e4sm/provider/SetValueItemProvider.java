...
/**
 * This is the item provider adapter for a {@link e4sm.de.metamodel.e4sm.SetValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetValueItemProvider extends NamedElementItemProvider {
	/**
	...
	protected void addProbabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SetValue_probability_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SetValue_probability_feature",
								"_UI_SetValue_type"),
						e4smPackage.Literals.SET_VALUE__PROBABILITY, true, false, false,
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SetValue_size_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SetValue_size_feature",
								"_UI_SetValue_type"),
