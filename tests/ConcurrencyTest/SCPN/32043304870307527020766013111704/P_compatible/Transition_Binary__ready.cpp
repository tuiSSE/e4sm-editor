/************************************************************
	...
	Transition_Binary__ready.cpp  -  generated by CodeGenerator r$Rev$
...
Transition_Binary__ready::Transition_Binary__ready(int uniqueid, const char* name, NetClass* net, PlaceIdentMap places, string pagePath, double firingWeight, int priority, bool exp, bool takeFirst, bool isInfinite, bool hasLocalGuard) :
	Transition(uniqueid, name, net, places, pagePath, firingWeight, priority, exp, takeFirst, isInfinite, hasLocalGuard)
,
	x_Place ( *(net->getPlace( &places, "Binary_in_1"))),
	nona1_Place ( *(net->getPlace( &places, "Binary_main")))
{
}

Transition_Binary__ready::~Transition_Binary__ready()
{
}

bool Transition_Binary__ready::globalGuard()
{
	return true;
}
void Transition_Binary__ready::initGlobalGuards()
{
}

void Transition_Binary__ready::moveTokens(TokenList &binding)
{
...
TempBindingList* Transition_Binary__ready::generateBindingList()
{
	TokenList* tok;
...
void Transition_Binary__ready::log(TokenList &binding)
{
}

double Transition_Binary__ready::display(TokenList &binding)
{
	return 0.0;
}

Seconds_T Transition_Binary__ready::getFiringDelay(TokenList &binding) const
{
	return Transition::getFiringDelay(binding);
}

bool Transition_Binary__ready::hasTimeguard() const
{
	return false;
}

Seconds_T Transition_Binary__ready::Timeguard(const DateTime& now)
{
	return 0.0;
}
